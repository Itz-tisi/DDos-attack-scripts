...
async def genkey(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user_id in ['1525613151', '7461925686']:  # Replace with your admin IDs
...
async def bgmi(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    flooding_command = ['./DDos.py', target_ip, port, duration, str(DEFAULT_THREADS)]
...
def main() -> None:
    application = ApplicationBuilder().token('7461925686:AAHiQp1RS7YAVFVVHoWEyKgaE5wGYgO0QJo').build()  # Replace with your BOT_TOKEN
